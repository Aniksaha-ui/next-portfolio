...
const SingleTraining = ({ training }: { training: any }) => {
  const { certificate_url, title, provider, start_date, end_date,status,description } = training;

  return (
    <div className="w-full">
  <div
    className="shadow-md dark:shadow-lg rounded-lg bg-white dark:bg-dark p-6 lg:p-5 xl:p-7 transition-all duration-300 hover:shadow-xl dark:hover:shadow-gray-dark"
  >
    {/* Certificate Image */}
